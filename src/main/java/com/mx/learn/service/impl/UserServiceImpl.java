...
import com.mx.learn.common.TokenCache;
import com.mx.learn.dao.UserMapper;
import com.mx.learn.pojo.User;
import com.mx.learn.service.IUserService;
import com.mx.learn.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse selectQuestion(String username) {
        ...
        return ServerResponse.createByErrorMessage("找回密码的方法是空的");
    }
    ...
    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken) {
        ...
        if (org.apache.commons.lang3.StringUtils.equals(forgetToken, token)) {
            ...
            return ServerResponse.createByErrorMessage("token错误，请重新登录获取token");
        }
