...
public class ProductManageController {
    ...
    @RequestMapping("richtext_imp_upload.do")
    @ResponseBody
    public Map rechtextImgUpload(HttpSession session, @RequestParam(value = "uploadFile",required = false) MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
